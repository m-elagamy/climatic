    ...
    <section className="section-style self-start">
      ...
      <div className="relative">
        ...
        <Image
          ...
          height={120}
          priority
          className={`absolute left-1/2 top-1/2 transition-transform duration-500 ease-in-out dark:invert`}
          style={{
            transform: `translateX(-50%) translateY(-50%) rotate(${wind_degree}deg)`,
          }}
        />
        <h3 className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-nowrap text-sm">
          {windSpeed} km/h
        </h3>
      </div>
    </section>
