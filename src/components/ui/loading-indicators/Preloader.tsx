  ...
  return (
    <div className="preloader absolute left-1/2 top-1/2 grid w-80 -translate-x-1/2 -translate-y-1/2 place-items-center opacity-100">
      ...
      >
        <path
          fill="none"
          className="fill-[#e0e0e0] stroke-[#9999995b]"
      ...
      <div className="absolute mt-[85px] h-[80px] *:float-left *:ml-[4px] *:h-[10px] *:w-[3px] *:animate-drop *:rounded-b-[6px] *:bg-[#89CFF0] *:opacity-100">
